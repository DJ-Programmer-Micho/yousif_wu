      ...
      <div class="row align-items-center">
        <div class="col-lg-8">
          <div class="d-flex align-items-center mb-3">
            ...
            <div>
              <h3 class="mb-1 fw-bold">{{ __('Rejected Transfers') }}</h3>
              <p class="mb-0 opacity-75">{{ __('Manage and track rejected money transfers') }}</p>
            </div>
          </div>
        </div>
        <div class="col-lg-4">
          <div class="stats-card">
            <div class="d-flex align-items-center justify-content-between">
              <div>
                <div class="small opacity-75 mb-1">{{ __('Total Rejected') }}</div>
                <div class="h4 mb-0 fw-bold">{{ $allsenders }}</div>
                <div class="small opacity-75">
                  <span class="status-indicator bg-danger"></span>
                  {{ __('Rejected transfers') }}
                </div>
              </div>
            ...
            <tr>
              ...
              <td class="text-start">
                <div class="d-inline-flex align-items-center gap-2">
                  <div class="avatar-modern bg-danger bg-opacity-10 text-white">{{ $sInit !== '' ? $sInit : '—' }}</div>
              ...
              <td class="text-start">
                <div class="d-inline-flex align-items-center gap-2">
                  <div class="avatar-modern bg-danger bg-opacity-10 text-white">{{ $rInit !== '' ? $rInit : '—' }}</div>
                  <div class="text-start">
                    <div class="fw-semibold" style="font-size:14px">
          ...
          @empty
            <tr>
              <td colspan="{{ $this->isAdmin ? 10 : 9 }}" class="text-center text-muted py-4">
                {{ __('No Rejected transfers found.') }}
              </td>
            </tr>
          @endforelse
          </tbody>
