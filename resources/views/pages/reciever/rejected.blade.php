...
<style>
  ...
  /* MODERN */
          :root {
            ...
            --secondary-gradient: linear-gradient(325deg, #fb9393 0%, #f5576c 100%);
            --success-gradient: linear-gradient(325deg, #ea6666 0%, #a24b4b 100%);
...
@section('app')
                ...
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb m-0 p-0">
                            ...
                            <li class="breadcrumb-item text-muted active">{{ __('Receive Transfers') }}</li>
                            <li class="breadcrumb-item text-muted active" aria-current="page"><b>{{ __('Rejected') }}</b> {{ __('Transfers') }}</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="container-fluid mt-3">
        @livewire('receiver.rejected-transfer-livewire')
    </div>
@endsection
