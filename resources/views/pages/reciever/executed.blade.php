...
<style>
  ...
  /* MODERN */
          :root {
            ...
            --success-gradient: linear-gradient(325deg, #80ea66 0%, #4ba27e 100%);
...
@section('app')
                ...
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb m-0 p-0">
                            ...
                            <li class="breadcrumb-item text-muted active" aria-current="page"><b>{{ __('Executed') }}</b> {{ __('Transfers') }}</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="container-fluid mt-3">
        @livewire('receiver.executed-transfer-livewire')
    </div>
@endsection
